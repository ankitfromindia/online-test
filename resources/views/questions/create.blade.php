        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-8 form-group">
                    ...
                    {!! Form::textarea('question_text', old('question_text'), ['class' => 'form-control ', 'placeholder' => '', 'rows' => 2]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-8 form-group">
                    ...
                    {!! Form::textarea('code_snippet', old('code_snippet'), ['class' => 'form-control ', 'placeholder' => '', 'rows' => 4]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-8 form-group">
                    ...
                    {!! Form::textarea('answer_explanation', old('answer_explanation'), ['class' => 'form-control ', 'placeholder' => '', 'rows' => 2]) !!}
                    <p class="help-block"></p>
            ...
            <div class="row hidden">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('more_info_link', old('more_info_link'), ['class' => 'form-control', 'placeholder' => '', 'rows' => 2]) !!}
                    <p class="help-block"></p>
...
{!! Form::submit( 'Save', ['class' => 'btn btn-danger','value' => 'save', 'name' => 'submitbutton'])!!}

{!! Form::submit( 'Save and Continue', ['class' => 'btn btn-danger', 'name' => 'submitbutton', 'value' => 'save-draft']) !!}
